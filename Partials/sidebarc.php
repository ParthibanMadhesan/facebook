        ...
        <div class="text-white mt-1">
                ...
                <?php if (isset($_SESSION['email'])): ?>
                    ...
                    <div class="flex flex-col justify-center content-start">
                        <h2 class="font-normal text-black"><?php echo htmlspecialchars($_SESSION['firstname']); ?></h2>
                    </div>
                    <?php endif; ?>
                </a>
                <a href="friendslist.php" class="hover:bg-gray-300 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                ...
                <a href="../friends.php" class="hover:bg-gray-300 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                    ...
                    <div class="flex flex-col justify-center content-start">
                        <h2 class="ffont-normal text-black">friendsrequests</h2>
                        <div class="text-xs text-blue-400 flex justify-start items-center space-x-1">
                        
                        </div>
                    </div>
                </a>
                <a href="create_post.php" class="hover:bg-gray-300 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                    <div class="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="flex flex-col justify-center content-start">
                        <h2 class="font-normal text-black">create posts</h2>
                        <div class="text-xs text-blue-400 flex justify-start items-center space-x-1">
                ...
                <a href="notifications.php" class="hover:bg-gray-300 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                    <div class="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="flex flex-col justify-center content-start">
                        <h2 class="font-normal text-black">notifications</h2>
                        <div class="text-xs text-blue-400 flex justify-start items-center space-x-1">
                          
                        </div>
                    </div>
                </a>
                <a href="chat.php" class="hover:bg-gray-300 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                    <div class="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                    ...
                    <div class="flex flex-col justify-center content-start">
                        <h2 class="font-normal text-black">messages</h2>
                        <div class="text-xs text-blue-400 flex justify-start items-center space-x-1">
        ...
        <div class="group flex-1">
            ...
            <div class="text-white mt-1">
                <a href="" class="hover:bg-gray-300 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                    ...
                    <div class="flex flex-col justify-center content-start">
                        <h2 class="font-normal text-black">learning website</h2>
                    </div>
                </a>
                <a href="https://chatgpt.com/" class="hover:bg-gray-300 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                    <div class="w-10 h-10 rounded-full overflow-hidden">
                        <img class="w-full" src="https://freelogopng.com/images/all_img/1681039084chatgpt-icon.png" alt="Standoff 2">
                    </div>
                    <div class="flex flex-col justify-center content-start">
                        <h2 class="font-normal text-black">chatgpt</h2>
                    </div>
                </a>
                <a href="https://www.w3schools.com" class="hover:bg-gray-300 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                    <div class="w-10 h-10 rounded-full overflow-hidden">
                        <img class="w-full" src="https://picsum.photos/200/300?random=3" alt="Call of Duty">
                    </div>
                    <div class="flex flex-col justify-center content-start">
                        <h2 class="font-normal text-black">w3schools</h2>
                    </div>
                </a>
                <a href="https://www.king.com/game/candycrush" class="hover:bg-gray-300 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                    <div class="w-10 h-10 rounded-full overflow-hidden">
